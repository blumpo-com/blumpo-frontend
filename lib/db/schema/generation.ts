import { pgTable, uuid, timestamp, text, jsonb, bigint, boolean, index } from 'drizzle-orm/pg-core';
...
export const generationJob = pgTable('generation_job', {
  ...
  // Quick ads generation flag
  autoGenerated: boolean('auto_generated').notNull().default(false), // True if automatically generated for quick ads (not manually created)
