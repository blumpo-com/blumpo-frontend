 ...
 */
export function summarizeForPR({ frontmatter, slug }) {
  const prTitle = `blog: ${frontmatter.title}`;
  
  const prBody = `🎉 New article ready for review!
...
---
*Generated by blog post workflow*`;
...
async function main() {
  ...
  try {
    switch (command) {
      ...
      case 'pr-summary': {
        // Usage: node blog-utils.mjs pr-summary <mdxPath>
