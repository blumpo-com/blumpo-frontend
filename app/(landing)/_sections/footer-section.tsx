  ...
  return (
    <>
      ...
      <footer className="w-full bg-gradient-to-b from-[rgba(249,250,251,0.5)] to-[rgba(198,240,234,0.5)] mt-20">
        {/* CTA Section */}
        <div className="flex flex-col gap-5 lg:gap-30 items-center justify-center px-4 py-[25px] overflow-visible">
          <h2 className="header-black">
            Ready to try Blumpo in action?
          </h2>
          <div className="w-full max-w-[712px] relative hidden lg:block overflow-visible">
            <video
              autoPlay
              loop
              muted
